...
export const WORKSPACE_SUBTABS = {
  dashboard: [
    { id: 'mission_control', label: '⚡ Live Mission Control', icon: 'activity' },
    { id: 'system_arch', label: '🏛️ Architecture Blueprint', icon: 'layers' },
  ],
  core: [
    ...
    { id: 'symbolic', label: 'Symbolic Formulas (SQL)', icon: 'binary' },
  ...
  automl: [
    ...
    { id: 'pareto', label: 'Pareto Flight Simulator', icon: 'crosshair' },
    { id: 'simulator', label: 'What-If & Recourse', icon: 'sliders' },
    { id: 'cockpit', label: 'Champion vs Challenger', icon: 'columns' },
    { id: 'stress', label: 'Monte Carlo Stress Test', icon: 'alert-triangle' },
    { id: 'conformal', label: 'Conformal Uncertainty', icon: 'check-circle' },
    { id: 'active_learning', label: 'Active Learning Queue', icon: 'user-check' },
  ],
  adaptive: [
    { id: 'causal', label: 'Causal DAG Studio', icon: 'target' },
  ...
  governance: [
    ...
    { id: 'drift', label: 'Drift Sentinel & MMD', icon: 'git-commit' },
    { id: 'sql', label: 'In-Database SQL Transpiler', icon: 'database' },
    { id: 'code', label: 'Production Code & Docker', icon: 'code' },
    { id: 'dossier', label: 'Executive Audit Dossier', icon: 'file-check' },
